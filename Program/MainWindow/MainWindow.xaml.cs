...
namespace RB4InstrumentMapper
{
    public partial class MainWindow : Window
    {
        ...
        private const string SubKeyPath = @"SOFTWARE\RB4InstrumentMapper";
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (LoadFromRegistry("start"))
            {
                autoStartCheckBox.IsChecked = true;
                StartCapture();
            }

            if(LoadFromRegistry("boot"))
            {
        ...
        {
            bool state = autoStartCheckBox.IsChecked.GetValueOrDefault();
            SaveToRegistry("start", state);
        }
        private void startupBootCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
        {
            bool state = startupCheckBox.IsChecked.GetValueOrDefault();
            SaveToRegistry("boot", state);
            if (state)
            {
        ...
        public static void SaveToRegistry(string keyName, bool value)
        {
        ...
        public static bool LoadFromRegistry(string keyName, bool defaultValue = false)
        {
